package com.example.mov.dashboard
...
class WhoPlayAdapter(private var data: List<Plays>,
                     private val listener: (Plays) -> Unit)
    : RecyclerView.Adapter<WhoPlayAdapter.LeagueViewHolder>() {
